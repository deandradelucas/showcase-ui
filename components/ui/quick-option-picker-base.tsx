    ...
    >
      ...
      >
                ...
                {data.map((option, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`relative flex cursor-pointer items-center gap-2 px-5 py-3 text-[15px] font-semibold transition-all duration-300 ${roundedClasses} bg-background ${
        ...
        <motion.button
          ...
          className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-transparent px-4 py-4 transition-all duration-300 select-none ${
