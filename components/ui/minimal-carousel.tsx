                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <motion.button
                      ...
                      className="flex cursor-pointer items-center gap-1.5 rounded-full bg-white/10
                  ...
                  <div className="flex items-end justify-between mt-4">
                    ...
                    <button
                      ...
                      className="cursor-pointer rounded-full bg-white/30 px-3 py-1 sm:px-4 sm:py-1.5
