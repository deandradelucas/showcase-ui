          ...
          <AnimatePresence mode="popLayout" initial={false}>
            {!isOpen ? (
              ...
              <motion.button
                ...
                transition={{ duration: 0.15 }}
                className="cursor-pointer bg-white dark:bg-neutral-950 border-2 border-neutral-100 dark:border-neutral-800 p-1.5 px-1.5 rounded-md text-black dark:text-white transition-colors"
              >
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {data.assignees.map((user, i) => (
                  ...
                  >
                    <img alt={user.name} src={user.avatar} className="w-7 h-7 rounded-full object-cover" />
