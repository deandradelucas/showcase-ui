                ...
                style={{
                  ...
                  background: `
                    linear-gradient(
                      90deg,
                      transparent 0%,
                      color-mix(in oklch, var(--background) 15%, transparent) 20%,
                      color-mix(in oklch, var(--background) 90%, transparent) 50%,
                      color-mix(in oklch, var(--background) 15%, transparent) 80%,
                      transparent 100%
                    )
                  `,
                  filter: 'blur(6px)',
          ...
          <AnimatePresence mode="popLayout" initial={false}>
            {!revealed && (
              <motion.button
                ...
                className="bg-muted text-foreground flex h-full w-full cursor-pointer items-center justify-center rounded-lg"
              >
                <BsEyeFill size={22} />
              </motion.button>
            )}
            ...
            {revealed && (
              <motion.button
                ...
                animate={{ scale: 1, opacity: 1 }}
                exit={{ scale: 0.85, opacity: 0 }}
                className={`relative flex h-full w-full cursor-pointer items-center justify-center rounded-lg transition-colors duration-300 ${
                  copied
