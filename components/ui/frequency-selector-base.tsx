            ...
            >
              <div className="flex items-center gap-2">
                ...
                >
                  {FREQUENCIES.map((type) => (
                    <button
                      ...
                      className="text-foreground relative flex h-full flex-none cursor-pointer items-center justify-center px-4 text-xs font-bold sm:flex-1 sm:min-w-fit sm:px-6 sm:text-[15px]"
                    >
                      {tempType === type && (
                        <motion.div
                          layoutId="active-tab"
                ...
                <motion.button
                  ...
                  className="bg-foreground text-background flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg sm:h-12 sm:w-12"
                >
                  <Check size={18} />
                </motion.button>
              </div>
                    ...
                    >
                      {SUB_OPTIONS[tempType].map((option) => (
                        <button
                          ...
                          className="text-foreground relative flex h-8 cursor-pointer items-center justify-center rounded-lg text-[10px] font-bold sm:h-9 sm:text-sm"
                        >
                          {tempSubValue === option && (
                            <motion.div
                              layoutId="active-sub"
