        ...
        <AnimatePresence mode="popLayout">
          {!isOpen ? (
            <motion.button
              ...
              className="group border-border bg-background text-muted-foreground hover:text-foreground absolute top-0 left-0 flex h-10 w-full cursor-pointer items-center gap-3 overflow-hidden rounded-lg border px-4 py-2 shadow-sm"
            ...
            <motion.div
              layoutId="command-pallete"
              transition={sharedTransition}
              className="border-border bg-popover absolute -top-2 -left-2 z-50 flex h-80 w-xs flex-col overflow-hidden rounded-lg border shadow-2xl md:w-[400px]"
                        ...
                        <div className="space-y-0.5">
                          {section.items.map((item) => {
                            ...
                            return (
                              <button
                                key={item.id}
                                className={`group flex w-full cursor-pointer items-center justify-between rounded-lg px-3 py-2.5 text-left ${isActive ? 'bg-accent text-accent-foreground' : 'text-muted-foreground hover:text-foreground'} `}
