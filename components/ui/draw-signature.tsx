          ...
          <AnimatePresence mode="popLayout" initial={false}>
            {step === "idle" && (
              <motion.button
                ...
                className="flex cursor-pointer items-center gap-2 rounded-full bg-neutral-100 px-8 py-5 text-lg font-bold text-neutral-900 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700"
              >
              ...
              >
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-neutral-400 text-white hover:bg-neutral-500 dark:bg-neutral-700 dark:hover:bg-neutral-600"
                  >
                    <X size={20} />
                  </button>
                </div>
                ...
                <motion.button
                  ...
                  className="mt-4 flex w-full cursor-pointer items-center justify-center gap-2 rounded-full bg-neutral-100 px-6 py-4 text-lg font-bold text-neutral-900 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700"
                >
                  <motion.div layoutId="container-button-icon">
                    <MdDraw size={28} />
                  </motion.div>
            ...
            {step === "done" && (
              ...
              >
                ...
                <motion.button
                  ...
                  onClick={() => setStep("drawing")}
                  className="cursor-pointer rounded-full bg-neutral-100 p-4 text-neutral-900 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700"
                >
                  <FaPen size={22} />
                </motion.button>
              </motion.div>
