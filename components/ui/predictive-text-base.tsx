              ...
              >
                {suggestions.map((word, i) => (
                  <button
                    ...
                    className={`cursor-pointer px-3 py-1 text-xs font-bold whitespace-nowrap transition-colors sm:px-4 sm:text-sm ${
            ...
            <AnimatePresence mode="wait">
              {text.length > 0 ? (
                <motion.button
                  ...
                  onClick={handleSend}
                  className="bg-primary text-primary-foreground flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg shadow-md transition-all active:scale-90 sm:h-10 sm:w-10"
                >
