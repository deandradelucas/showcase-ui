...
export const themeTogglerButtonVariants = tv({
  base: [
    "relative inline-flex shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-full border border-transparent text-foreground outline-none select-none",
...
function ThemeTogglerButton({
  ...
  const displayMode: ThemeTogglerButtonMode =
    activeMode === "system" ? "system" : resolvedTheme === "dark" ? "dark" : "light";
