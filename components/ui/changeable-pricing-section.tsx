      ...
      <div className="w-full max-w-[460px] bg-neutral-100 dark:bg-neutral-950 rounded-[24px] p-1.5 shadow-sm ring-1 ring-neutral-200/50 dark:ring-neutral-800/50">
        ...
        <div className="flex items-center justify-between px-3 py-4">
          ...
          <div className="flex items-center bg-neutral-200 dark:bg-neutral-950 p-1 rounded-full relative z-0 ring-1 ring-transparent dark:ring-neutral-600/50">
            ...
            <button
              ...
              className={`jet w-[72px] cursor-pointer py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase transition-colors z-10 ${billingCycle === "monthly" ? "text-neutral-800 dark:text-orange-500" : "text-neutral-400 dark:text-neutral-500"}`}
            >
              {monthlyLabel}
            </button>
            <button
              onClick={() => setBillingCycle("yearly")}
              className={`jet w-[72px] cursor-pointer py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase transition-colors z-10 ${billingCycle === "yearly" ? "text-neutral-800 dark:text-orange-500" : "text-neutral-400 dark:text-neutral-500"}`}
            >
              {yearlyLabel}
            </button>
          </div>
        ...
        <div className="flex flex-col gap-4 items-center sm:flex-row sm:justify-between mt-5 px-3 pb-2">
          ...
          <button
            ...
            className="w-full sm:w-auto cursor-pointer bg-orange-500 text-white px-8 py-2.5 rounded-full text-[13px] font-medium hover:bg-orange-600 active:scale-95 transition-all outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-orange-500"
          >
            {buttonText}
          </button>
        </div>
