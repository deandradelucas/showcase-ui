...
interface CarrosselInterativoMonocromaticoProps {
  className?: string;
  images?: { src: string; title: string }[];
  isMonochrome?: boolean;
}

function CarrosselInterativoMonocromatico({
  className = '',
  images = DEFAULT_ASSETS,
  isMonochrome = true
}: CarrosselInterativoMonocromaticoProps) {
...
export { CarrosselInterativoMonocromatico };