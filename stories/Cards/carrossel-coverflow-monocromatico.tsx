...
interface CarrosselCoverflowMonocromaticoProps {
  className?: string;
  images?: { src: string; title: string }[];
  isMonochrome?: boolean;
}

function CarrosselCoverflowMonocromatico({
  className = '',
  images = DEFAULT_ASSETS,
  isMonochrome = true
}: CarrosselCoverflowMonocromaticoProps) {
...
export { CarrosselCoverflowMonocromatico };