// Fundo adaptado de react-bits (DavidHDev/react-bits, MIT) — Animations/SplashCursor
// Original prende os listeners de mouse/touch em window/document e cobre a tela inteira;
// aqui os eventos ficam restritos ao canvas do proprio card (getBoundingClientRect), sem vazar pra fora do hero.
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    canvas.addEventListener('mousemove', handleFirstMouseMove);
    ...
    canvas.addEventListener('touchstart', handleFirstTouchStart);
  ...
  return (
    <div className="absolute inset-0 z-20 overflow-hidden">
      <canvas ref={canvasRef} id="fluid" className="block h-full w-full"></canvas>
    </div>
  );
}

interface SplashCursorHeroProps {
  /** Intensidade do respingo ao mover o mouse (o "volume" da animação). */
  splatForce?: number;
  /** Tamanho do respingo ao mover o mouse. */
  splatRadius?: number;
}

function SplashCursorHero({
  splatForce = 6000,
  splatRadius = 0.2,
}: SplashCursorHeroProps = {}) {
  return (
    <div className="relative flex min-h-[32rem] w-full items-center justify-center overflow-hidden rounded-md bg-black">
      <SplashCursor
